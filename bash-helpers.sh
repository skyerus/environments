...
alias itunesenvs="cd $DIR/docker/itunes-to-spotify"
...
alias docker-itunes-up="sudo chown -R ${USER}:${USER} $DIR; itunesenvs; sudo docker-compose up -d; genhosts"
alias docker-itunes-down="itunesenvs; sudo docker-compose down"
